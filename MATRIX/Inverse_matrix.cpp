//Diego Cuevas
//This program request to user a matrix 3 by 3 and shows the inverse matrix.
#include <iostream>
using namespace std;
...
int main(int argc, char *argv[]) {
    ...
    float attached[3][3] = {}, inverse[3][3]; //Create array for attached and inverse matrix
    ...
    for (int i = 0; i < 3; i++) //Calculate the attached matrix
    {
        for (int j = 0; j < 3; j++)
        {
            ...
            inverse[i][j] = attached[i][j] / determinant;
        }
